...
#define STRING_CONFIG_H_AUTHOR "sigsegv0x0b@gmail.com" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "CR-10S SP 003"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 715 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -5, -2.85 }
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define MESH_INSET 65              // Set Mesh bounds as an inset region of the bed
...
#define LCD_BED_TRAMMING
  ...
  //#define BED_TRAMMING_INSET_LFRB { 30, 30, 64, 30 } // (mm) Left, Front, Right, Back insets
  #define BED_TRAMMING_INSET_LFRB { 10, 10,44, 10 } // (mm) Left, Front, Right, Back insets
